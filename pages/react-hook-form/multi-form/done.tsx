  ...
  return (
    <div className="w-6/12 mx-auto">
      <div className="shadow m-4">
        <FormHeader backgroundColor={['from-emerald-500', 'to-teal-500']} title="Album Register Complete" />
        ...
        <button
          className="block p-3 w-full text-center text-white font-bold tracking-widest transition uppercase bg-teal-600 hover:bg-teal-500 active:bg-teal-400"
          onClick={onLeave}
        >
          CLOSE
        </button>
