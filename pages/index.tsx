    ...
    <>
      <header className="sticky top-0 w-full py-4 bg-white border-b z-50">
        <nav className="max-w-6xl mx-auto">
          <h1 className="text-xl font-bold">Next+TS Multistep Form Tests.</h1>
        </nav>
      </header>
      <main ref={MainRef} className="min-h-[200vh]">
        <section className="h-[95vh] py-8 bg-gradient-to-br from-blue-100 to-blue-50 overflow-hidden relative">
          <div className="w-full max-w-6xl mx-auto mt-96">
            ...
            <div className="flex gap-3">
              <Link href="/react-hook-form/single-form">
                <a className="px-4 py-2 text-sm font-bold text-blue-700 bg-blue-200 rounded-full">
                  Test Single Form Now →
                </a>
              </Link>
              <Link href="/react-hook-form/multi-form">
                <a className="px-4 py-2 text-sm font-bold text-teal-600 bg-teal-200 rounded-full">
                  Test Multistep Form Now →
                </a>
              </Link>
            </div>
          </div>
          <div
            ref={SignFormIcon}
            className="absolute origin-center bottom-[60%] right-[0%] -translate-x-1/2 translate-y-1/2"
          >
        ...
        <section className="h-[95vh] py-8 overflow-hidden relative">
          <div className="max-w-6xl mx-auto flex flex-col gap-8 items-start">
            <div ref={SecondSectionFirstTitle} className="w-1/2 mt-24">
              ...
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Vero praesentium recusandae nobis, ducimus
                fugiat beatae perferendis ipsam corrupti eum adipisci animi quia velit quo doloribus quas accusantium ut
                labore consectetur.
              </p>
            </div>
